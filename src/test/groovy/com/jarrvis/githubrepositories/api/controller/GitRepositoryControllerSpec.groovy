package com.jarrvis.githubrepositories.api.controller
...
@WebMvcTest(controllers = [com.jarrvis.githubrepositories.api.GitRepositoryController])
class GitRepositoryControllerSpec extends Specification {
    ...
    @Autowired
    com.jarrvis.githubrepositories.service.GitRepositoryService gitRepositoryService
    ...
    static class StubConfig {
        ...
        @Bean
        com.jarrvis.githubrepositories.service.GitRepositoryService githubRepositoryService() {
            return detachedMockFactory.Stub(com.jarrvis.githubrepositories.service.GitRepositoryService)
        }
    }
}