...
import com.jarrvis.githubrepositories.patterns.GithubRepositoriesPatterns;
import io.vavr.API;
...
public class GlobalExceptionHandlingControllerAdvice {
    ...
    public VndErrors handleWebClientResponseException(HttpServletRequest req, HttpServletResponse resp,
        ...
        HttpStatus status = Match(ex).of(
                API.Case(GithubRepositoriesPatterns.$WebClientResponseException($(HttpStatus.NOT_FOUND.value()), $(), $(), $(), $()), () -> HttpStatus.NOT_FOUND),
                API.Case(GithubRepositoriesPatterns.$WebClientResponseException($(HttpStatus.FORBIDDEN.value()), $(), $(), $(), $()), () -> HttpStatus.TOO_MANY_REQUESTS),
